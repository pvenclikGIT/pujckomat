...
const P = [
  { id:'airbank', name:'Air Bank', logo:'assets/logos/airbank.ico', type:'bank', color:'#0ea5e9', initial:'AB', rateFrom:3.9, rateTo:10.9, rpsnFrom:4.2, rpsnTo:11.5, minAmt:10000, maxAmt:1000000, minMo:6, maxMo:120, approval:10, fairness:9.2, noFees:true, earlyFree:true, online:true,
  ...
  { id:'csob', name:'CSOB', logo:'assets/logos/csob.png', type:'bank', color:'#1d4ed8', initial:'CS', rateFrom:4.5, rateTo:12.9, rpsnFrom:4.9, rpsnTo:13.8, minAmt:20000, maxAmt:800000, minMo:12, maxMo:96, approval:15, fairness:8.5, noFees:true, earlyFree:true, online:true,
    fees:{ setup:'Zdarma', maintenance:'Zdarma', earlyRepay:'Zdarma' },
  ...
  { id:'moneta', name:'MONETA', logo:'assets/logos/moneta.ico', type:'bank', color:'#059669', initial:'MO', rateFrom:4.9, rateTo:14.9, rpsnFrom:5.3, rpsnTo:16.2, minAmt:20000, maxAmt:800000, minMo:12, maxMo:96, approval:5, fairness:7.8, noFees:false, earlyFree:true, online:true,
  ...
  { id:'kb', name:'Komercni banka', logo:'assets/logos/kb.png', type:'bank', color:'#dc2626', initial:'KB', rateFrom:4.3, rateTo:11.9, rpsnFrom:4.7, rpsnTo:12.8, minAmt:30000, maxAmt:1200000, minMo:12, maxMo:120, approval:30, fairness:8.8, noFees:true, earlyFree:true, online:true,
    fees:{ setup:'Zdarma', maintenance:'Zdarma', earlyRepay:'Zdarma' },
    pros:['Limit az 1,2 mil Kc','Osobni banker','Flexibilni splatky'], cons:['Pomalejsi schvalovani','Vyzaduje ucet u KB'] },
  { id:'trinity', name:'Trinity Bank', logo:'assets/logos/trinity.ico', type:'bank', color:'#0f172a', initial:'TB', rateFrom:3.99, rateTo:7.9, rpsnFrom:3.99, rpsnTo:8.2, minAmt:50000, maxAmt:2500000, minMo:12, maxMo:96, approval:20, fairness:9.5, noFees:true, earlyFree:true, online:true,
  ...
  { id:'zonky', name:'Zonky', logo:'assets/logos/zonky.ico', type:'p2p', color:'#f97316', initial:'ZO', rateFrom:3.49, rateTo:15.9, rpsnFrom:4.1, rpsnTo:19.5, minAmt:20000, maxAmt:1000000, minMo:6, maxMo:84, approval:60, fairness:8.0, noFees:true, earlyFree:true, online:true,
    fees:{ setup:'Zdarma', maintenance:'Zdarma', earlyRepay:'Zdarma' },
  ...
  { id:'cofidis', name:'Cofidis', logo:'assets/logos/cofidis.ico', type:'nonbank', color:'#eab308', initial:'CF', rateFrom:6.9, rateTo:21.9, rpsnFrom:7.5, rpsnTo:24.8, minAmt:5000, maxAmt:500000, minMo:6, maxMo:72, approval:5, fairness:6.5, noFees:false, earlyFree:false, online:true,
  ...
  { id:'homecredit', name:'Home Credit', logo:'assets/logos/homecredit.png', type:'nonbank', color:'#e11d48', initial:'HC', rateFrom:7.9, rateTo:25.9, rpsnFrom:8.9, rpsnTo:29.8, minAmt:5000, maxAmt:300000, minMo:3, maxMo:60, approval:3, fairness:5.8, noFees:false, earlyFree:false, online:true,
  ...
  { id:'csas', name:'Ceska sporitelna', logo:'assets/logos/csas.png', type:'bank', color:'#2563eb', initial:'CS', rateFrom:4.1, rateTo:11.5, rpsnFrom:4.5, rpsnTo:12.3, minAmt:20000, maxAmt:1000000, minMo:12, maxMo:96, approval:15, fairness:8.9, noFees:true, earlyFree:true, online:true,
    fees:{ setup:'Zdarma', maintenance:'Zdarma', earlyRepay:'Zdarma' },
    pros:['Nejvetsi banka v CR','George aplikace','Flexibilni splatky'], cons:['Urok zavisi na bonite','Vyzaduje ucet u CS'] },
  { id:'tatra', name:'Tatra banka', logo:'assets/logos/tatra.png', type:'bank', color:'#312e81', initial:'TT', rateFrom:4.9, rateTo:12.9, rpsnFrom:5.2, rpsnTo:13.8, minAmt:500, maxAmt:40000, minMo:6, maxMo:96, approval:10, fairness:8.7, noFees:true, earlyFree:true, online:true, isSK:true,
